...
src_unpack() {
	...
	LV=`curl --silent http://build.chromium.org/f/chromium/snapshots/chromium-linux-reliability/LATEST`
	...
	wget -c "http://build.chromium.org/f/chromium/snapshots/chromium-linux-reliability/${LV}/chrome-linux.zip" -O "${T}"/${PN}-${LV}.zip
